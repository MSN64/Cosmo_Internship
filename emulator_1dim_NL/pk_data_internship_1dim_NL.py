...
train_params = np.load('LHS_params_1dim20000_NL.npz')
...
def camb_cosmo(i):
    ...
    pars.set_cosmology(H0=100 * cosmo_params[i, 0], ombh2=0.02242, omch2=0.11933)
...
with open('pk_data_1dim20000_NL1.pkl', 'wb') as f, open('pk_data_1dim20000_NL2.pkl', 'wb') as g:
    pickle.dump(pk_matrix, f)
    pickle.dump(pk_nonlin_matrix, g)

with open('pk_data_1dim20000_NL1.pkl', 'rb') as f, open('pk_data_1dim20000_NL2.pkl', 'rb') as g:
