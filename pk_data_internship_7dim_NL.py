...
train_params = np.load('LHS_params_7dim100_NL.npz')
...
with open('pk_data_7dim100_NL1.pkl', 'wb') as f, open('pk_data_7dim100_NL2.pkl', 'wb') as g:
    pickle.dump(pk_matrix, f)
    pickle.dump(pk_nonlin_matrix, g)

with open('pk_data_7dim100_NL1.pkl', 'rb') as f, open('pk_data_7dim100_NL2.pkl', 'rb') as g:
